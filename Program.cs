...
namespace MyEMSL_MTS_File_Cache_Manager
{
	...
	internal class Program
	{
		...
		public const string PROGRAM_DATE = "December 11, 2013";

		protected static clsLogTools.LogLevels mLogLevel;

		protected static string mMTSServer;
		protected static string mLogDBConnectionString;
		protected static int mMinimumCacheFreeSpaceGB;
		protected static bool mLocalServerMode;
		...
		public static int Main(string[] args)
		{
			...
			try
			{
				...
				else
				{
					...
					// Attach the events
					downloader.ErrorEvent += new MessageEventHandler(downloader_ErrorEvent);
					downloader.MessageEvent += new MessageEventHandler(downloader_MessageEvent);
